    ...
    public partial class Teacherupdate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string sql = "select * from user where User_id ='" + Session["userid"] + "'";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql = "update user set name='" + TextBox1.Text.Trim() + "',Account='" + TextBox2.Text.Trim() + "',Password= '" + TextBox3.Text.Trim() + "',Age='" + TextBox4.Text.Trim() + "',Department='" + TextBox5.Text.Trim() + "',Title='" + TextBox6.Text.Trim() + "',number='" + TextBox7.Text.Trim() + "'where User_id='" + Session["userid"] + "'";
                MySqlCommand comm = new MySqlCommand(sql, conn);
